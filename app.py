...
if  chart_select == 'Yes':
    ...
    if agree:
        ...
        if neighbourhood_list == []:
            neighbourhood_multiselect = st.sidebar.multiselect("Neighbourhoods in NYC:", df.neighbourhood.unique(), default=['Chinatown','Midtown', 'West Village', 'Williamsburg'])
        else:
            neighbourhood_multiselect = st.sidebar.multiselect("Neighbourhoods in NYC:", neighbourhood_list)
